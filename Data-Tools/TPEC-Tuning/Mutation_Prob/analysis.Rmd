...
Mean of mutation prob 100 > mutation prob 25?
```{r task-146818-test-mean-tie-break, echo=FALSE}
mean(dplyr::filter(task_data, mutation_prob == 100)$test_accuracy) > mean(dplyr::filter(task_data, mutation_prob == 25)$test_accuracy)
```

Median equal for mutation prob 100, 75, and 50?
```{r task-146818-test-med-tie-break, echo=FALSE}
medians <- c(
  median(dplyr::filter(task_data, mutation_prob == 50)$test_accuracy),
  median(dplyr::filter(task_data, mutation_prob == 75)$test_accuracy),
  median(dplyr::filter(task_data, mutation_prob == 100)$test_accuracy)
)
...
Mean of mutation prob 75 > mutation prob 50 > ?
...
task_data$mutation_prob <- factor(task_data$mutation_prob, levels = c(100, 75, 25, 50))
...
task_data$mutation_prob <- factor(task_data$mutation_prob, levels = c(25, 100, 50, 75))
...
task_data$mutation_prob <- factor(task_data$mutation_prob, levels = c(100, 25, 75, 50))
pairwise.wilcox.test(x = task_data$diversity_metric, g = task_data$mutation_prob, paired = TRUE,
                p.adjust.method = "holm", alternative = "greater")
```
...
Medians for all mutation probabilities equal?
```{r task-190137-test-med-tie-break, echo=FALSE}
medians <- c(
  median(dplyr::filter(task_data, mutation_prob == 25)$test_accuracy),
  median(dplyr::filter(task_data, mutation_prob == 50)$test_accuracy),
  median(dplyr::filter(task_data, mutation_prob == 75)$test_accuracy),
  median(dplyr::filter(task_data, mutation_prob == 100)$test_accuracy)
)
...
### Pairwise Wilcoxon Signed-Rank Tests
```{r task-190137-test-wilcox, echo=FALSE}
pairwise.wilcox.test(x = task_data$test_accuracy, g = task_data$mutation_prob, paired = TRUE,
                p.adjust.method = "holm", alternative = "greater")
```
...
Mean of mutation prob 100 > mutation prob 75?
```{r task-359975-test-mean-tie-break, echo=FALSE}
mean(dplyr::filter(task_data, mutation_prob == 100)$test_accuracy) > mean(dplyr::filter(task_data, mutation_prob == 75)$test_accuracy)
```
